...
- 从多个水龙头获取测试 ETH
- 确保至少有 0.1 ETH
- 检查账户余额：`npx hardhat run scripts/check-balance.js --network sepolia`
...
**解决方案**:
- 可能是 gas price 设置过低
- 在 `hardhat.config.cjs` 中设置合适的 `gasPrice`
- 检查网络是否拥堵
